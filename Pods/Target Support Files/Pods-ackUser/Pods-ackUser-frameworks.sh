...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/AACustomDatePicker/AACustomDatePicker.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/XLPasswordInputView/XLPasswordInputView.framework"
fi
